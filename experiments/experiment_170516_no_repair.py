...
def run_test():
    queueing_system = ColdReserveQueueingSystem(name="System_20170516_no_repair", p_num=150)
    queueing_system.set_BMAP_queries_stream(matrD_0=np.array([[-86., 0.01], [0.02, -2.76]]),
                                            matrD=np.array([[85., 0.99], [0.2, 2.54]]),
                                            n=3,
                                            q=0.8)
    queueing_system.set_MAP_break_stream(np.array([[-800000, 100000], [200000, -1200000]]),
                                         np.array([[200000, 500000], [400000, 600000]]))
    queueing_system.set_PH_serv_unit1_stream(np.array([[0.2, 0.8]]), np.array([[-440., 15.], [40., -410.]]))
    ...
    queueing_system.set_PH_repair_stream(np.array([[0.9999, 0.0001]]), np.array([[-0.000001, 0.], [0., -230.]]))
