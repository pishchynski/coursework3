...
def run_test():
    ...
    queueing_system.set_BMAP_queries_stream(matrD_0=np.array([[-86., 0.01], [0.02, -2.76]]),
                                            ...
                                            n=3,
                                            q=0.8)
    queueing_system.set_MAP_break_stream(2*np.array([[-8., 1.], [2., -12.]]), np.array([[2., 5.], [4., 6.]]))
    ...
    queueing_system.set_PH_switch1_2_stream(np.array([[0.9, 0.1]]), 0.0000001 * np.array([[-220., 160.], [20., -300.]]))
    queueing_system.set_PH_switch2_1_stream(np.array([[0.9, 0.1]]), 0.0000001 * np.array([[-2200, 1600.], [200., -3000.]]))
    ...
    for i, charact in enumerate(characteristics):
        print("{}. ".format(str(i)), characteristics_loc[i], ':', characteristics[charact])
