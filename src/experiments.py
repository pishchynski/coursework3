...
def experiment_2_1(queueing_system: ColdReserveQueueingSystem, read_file=False):
    """
    ...
    if not read_file:
        try:
            ...
            for cor_coef in range(3):
                ...
                if cor_coef == 1:
                    matrH_0 = np.array([[-6.3408, 1.87977 * (10 ** (-6))], [1.87977 * (10 ** (-6)), -0.13888]]) * 1.7 / 2.4
                    matrH_1 = np.array([[6.3214, 0.01939], [0.10822, 0.03066]]) * 1.7 / 2.4
                ...
                output_table = BeautifulTable()
                output_table.column_headers = ['\\rho', 'h', 'P_1^{+}']
